...
france({ nomCom: "developer", categorie: "General", reaction: "🐐" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Naishan Nalvar", numero: "48888882100" },
      { nom: "᚛Naishan᚜", numero: "918590479072" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "Hello 👋\n *Welcome to Nalvar-Md!*\n\n*✦━━◆CREATOR INFO◆━━✦*\n\n\n *◇NAME: _Naishan Nalvar_*\n*◇AGE: xx*\n*◇LOCATION: _On Earth_*\n*◇BELIEVER: An Atheist  ✅*\n*◇FRIENDLY: YES ✅*\n*◇GAMES: _MLBB + GENSHIN_*\n*◇BIRTHDAY: _SEP 2_*\n*◇INSTAGRAM: https://instagram.com/n4lvar*\n*◇TG: t.me/Nalvar4477*\n\n______________________________\n\n*💙KEEP USING NALVAR-MD🤍*\n\n\n_The following are my contacts_:\n:";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/48888882100`},{quoted :ms})
